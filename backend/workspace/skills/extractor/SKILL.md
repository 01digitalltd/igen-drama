...
- **name**（必填）：角色全名
- **role**：角色定位，主角/配角/龙套
- **appearance**：样貌描写（300-500字）——性别、年龄感、五官、体态、气质。**必须引用剧本里的视觉事实**（年龄、职业、制服、发型、服装）；剧本没写衣服时，按职业或工作场合推断。**角色的性格特点不要单独输出，要转化为外在气质与神态融入样貌描写**（例如"性格冷峻"应写为"眼神冷峻、表情克制、少有笑意"）。不要编造明星脸或与剧本冲突的人种/年龄
...
- **prompt**：场景描述——只写空空间、固定陈设、年代质感、建筑与材质（纯背景空镜：不含人物、动作、对白，也不含可手持的剧情道具；桌椅灯具门窗等陈设要写）
