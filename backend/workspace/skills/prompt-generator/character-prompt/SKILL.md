...
- **左侧：正脸特写**——头部与肩部的正面近景，五官、发型清晰可见（3D Chibi 时光滑无毛孔），作为脸部辨识度的锚点
...
纯白背景。若项目是 3D Chibi：头身比约 1:2、头大身小、盲盒风三维、光滑树脂、均匀三维棚灯，禁止电影质感与真人皮肤；写实项目再用柔和均匀光线
```

## 描述顺序规则

把**最有辨识度的特征放在前面**，按此顺序落地 `appearance`（样貌）与 `styling`（妆造）的每个关键元素，不遗漏。**视觉必须跟剧本一致**：剧本写了的年龄、职业、制服、发型、服装、配饰都要写进提示词；职业/场合转化为服装（护士→护士服）。剧本没写五官时，只做不冲突的补全，不要换成另一个人种、年龄段或明星脸。
...
- 中性站姿、自然表情——方便作为参考图复用
- 光线要均匀、可复用：3D Chibi 用均匀三维棚灯，不要写实棚拍或电影光
- 输出必须是纯中文。若项目是 3D Chibi，必须写头身比约 1:2、头大身小、盲盒风三维、光滑树脂、没有毛孔，禁止「电影质感」「真人皮肤」「Unreal 写实」
- 不要写与项目画风冲突的媒介词；保存时仍会再注入项目视觉风格
