...
生成的是一张**清晰的广角建立镜头**空场景图：**完全没有人物**，完整展示前景、中景、后景、出入口、地面、墙面及主要陈设的固定相对位置。

**画风必须跟项目视觉风格一致。** 用户消息里的【视觉风格】要写进提示词开头。3D Chibi 时整张是盲盒风三维空场景（圆润卡通家具、简化墙面、均匀三维棚灯），禁止实拍办公室、街道、电影质感室内摄影。

这张图会作为该场景所有镜头的背景参考锚点：空间布局要读得懂、对得上、可复用。视角必须稳定、通用。
...
- 输出必须是纯中文，并写进项目视觉风格。3D Chibi 时场景必须是盲盒风 Q 版三维，圆润卡通家具，禁止「电影质感」「实拍摄影」「Unreal 写实」

## 禁止事项

- 任何人物——包括背影、剪影、照片/屏幕里的人（明确写"画面中没有任何人物"）
- 可手持或推动剧情的道具（信、刀、文件、信物等；这些由道具资产单独出图）。固定陈设（家具、灯具、门窗）必须保留
- 文字、招牌上的可读文字、水印、签名
