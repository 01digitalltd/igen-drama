    ...
    const drafted = await withTimeout(
      generateStructuredPrompt(
        ...
        [
          ...
          '纯中文单段。必须把【视觉风格】写进提示词：3D Chibi 时场景是盲盒风 Q 版三维空镜，圆润卡通家具，禁止电影质感实拍办公室。结尾写「画面中没有任何人物，空场景」。',
    ...
    const drafted = await withTimeout(
      generateStructuredPrompt(
        ...
        [
          ...
          '纯白背景、单件商品特写、纯中文单段。必须把【视觉风格】写进提示词：3D Chibi 时做成盲盒风三维玩具产品，光滑树脂，禁止真人产品摄影。',
